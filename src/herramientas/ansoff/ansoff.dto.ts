...
export class AnsoffResponse {
  ...
  constructor(ansoff: Ansoff) {
    ...
    this.productos = ansoff.productos.map(
...
export class ProductoResponse {
  ...
  constructor(producto: Producto) {
    ...
    this.situacionDelMercado =
      producto.situacionDelMercado as SituacionDelMercado;
    this.situacionDelProducto =
      producto.situacionDelProducto as SituacionDelProducto;
