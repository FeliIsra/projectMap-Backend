    ...
    export function calculate(situacionDelMercado: SituacionDelMercado, situacionDelProducto: SituacionDelProducto) {
        switch (situacionDelMercado) {
            case SituacionDelMercado.ACTUAL:
                if (situacionDelProducto == SituacionDelProducto.ACTUAL) return Estrategia.PENETRACION;
                else return Estrategia.DESARROLLO_DE_PRODUCTO
            case SituacionDelMercado.NUEVO:
                if (situacionDelProducto == SituacionDelProducto.ACTUAL) return Estrategia.DESARROLLO_DE_MERCADO;
